...
export default function IncludedSection() {
  return (
    <section id="roteiro" className="relative z-[5] -mt-24 sm:-mt-32 pt-0 pb-14 sm:pb-20 bg-deep-atlantic rounded-b-[3rem] sm:rounded-b-[5rem] shadow-[0_40px_100px_-20px_rgba(0,20,60,0.7)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 relative">
        <motion.div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {items.map((item, i) => (
            <motion.div
              ...
              className="group relative p-6 sm:p-8 rounded-[2rem] bg-white/[0.04] border border-white/[0.08] hover:border-electric-azure/30 transition-all duration-500 hover:bg-white/[0.07] backdrop-blur-sm shadow-xl hover:shadow-2xl"
            >
