...
export default function HotelSection() {
  return (
    <section id="hospedagem" className="relative py-20 sm:py-32 bg-surface-cool overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="relative rounded-[2.5rem] overflow-hidden mb-12 aspect-[21/9] shadow-[0_16px_40px_rgba(0,0,0,0.06)]"
        >
          <img
            src={hotelImg}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {hotels.map((hotel, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="p-6 sm:p-8 rounded-[2rem] overflow-hidden bg-white hover:border-electric-azure/30 transition-all duration-500 shadow-[0_16px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_50px_-15px_rgba(0,132,237,0.12)]"
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`text-sm ${hotel.breakfast ? "text-solar-flare font-medium" : "text-deep-atlantic/40"}`}>
                  {hotel.breakfastText}
                </span>
              </div>
              <Stars />
